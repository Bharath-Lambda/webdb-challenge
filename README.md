...
RDBMS stands for Relational Database Management System, and is the software that supports relational databases. They use SQL, or Structured Query Language, to create and manipulate data inside fo the database.

1. Why do tables need a `primary key`?

A primary key is a not null, unique field which easily identifies a rows. This makes searching for specific rows in a database much faster than trying to match any other field.
...
We need a parent row in one table to be related to several child rows in a second table as well a parent row in the second table to be able to have multiple child rows in the first table.
